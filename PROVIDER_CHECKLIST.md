...
The [provider-vault](https://github.com/topfreegames/crossplane-provider-vault) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-vault](https://github.com/crossplane-contrib/provider-jet-vault) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/topfreegames/crossplane-provider-vault/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/topfreegames/crossplane-provider-vault/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/topfreegames/crossplane-provider-vault/blob/main/hack/boilerplate.go.txt](https://github.com/topfreegames/crossplane-provider-vault/blob/main/hack/boilerplate.go.txt)
...
The [provider-vault](https://github.com/topfreegames/crossplane-provider-vault)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/topfreegames/crossplane-provider-vault/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/topfreegames/crossplane-provider-vault/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue vaults (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/topfreegames/crossplane-provider-vault/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Vaults: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/topfreegames/crossplane-provider-vault/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
