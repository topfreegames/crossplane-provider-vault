...
// Source: github.com/topfreegames/crossplane-provider-vault/internal/clients (interfaces: VaultClient,VaultSysClient,VaultLogicalClient)
...
// MockVaultLogicalClient is a mock of VaultLogicalClient interface.
type MockVaultLogicalClient struct {
	ctrl     *gomock.Controller
	recorder *MockVaultLogicalClientMockRecorder
}

// MockVaultLogicalClientMockRecorder is the mock recorder for MockVaultLogicalClient.
type MockVaultLogicalClientMockRecorder struct {
	mock *MockVaultLogicalClient
}

// NewMockVaultLogicalClient creates a new mock instance.
func NewMockVaultLogicalClient(ctrl *gomock.Controller) *MockVaultLogicalClient {
	mock := &MockVaultLogicalClient{ctrl: ctrl}
	mock.recorder = &MockVaultLogicalClientMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockVaultLogicalClient) EXPECT() *MockVaultLogicalClientMockRecorder {
	return m.recorder
}

// Delete mocks base method.
func (m *MockVaultLogicalClient) Delete(arg0 string) (*api.Secret, error) {
	m.ctrl.T.Helper()
...
func (mr *MockVaultLogicalClientMockRecorder) Delete(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockVaultLogicalClient)(nil).Delete), arg0)
}

// Read mocks base method.
func (m *MockVaultLogicalClient) Read(arg0 string) (*api.Secret, error) {
	m.ctrl.T.Helper()
...
func (mr *MockVaultLogicalClientMockRecorder) Read(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Read", reflect.TypeOf((*MockVaultLogicalClient)(nil).Read), arg0)
}

// Write mocks base method.
func (m *MockVaultLogicalClient) Write(arg0 string, arg1 map[string]interface{}) (*api.Secret, error) {
	m.ctrl.T.Helper()
...
func (mr *MockVaultLogicalClientMockRecorder) Write(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Write", reflect.TypeOf((*MockVaultLogicalClient)(nil).Write), arg0, arg1)
}
