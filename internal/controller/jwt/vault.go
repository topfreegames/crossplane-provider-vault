...
func RoleFromCrossplane(crossplane *v1alpha1.Jwt) *Role {
	...
	r := &Role{
		...
		UserClaimJsonPointer: *d.UserClaimJsonPointer,
		BoundSubject:         *d.BoundSubject,
		BoundClaims:          mapToInterface(d.BoundClaims),
		BoundClaimsType:      *d.BoundClaimsType,
		...
		VerboseOIDCLogging:   *d.VerboseOIDCLogging,
		...
		TokenNoDefaultPolicy: *d.TokenNoDefaultPolicy,
